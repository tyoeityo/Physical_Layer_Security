...
% hold on
% plot(MER, Cs_primary_sc_2,'k-v');
% hold on
% plot(MER,Cs_primary_sc_3,'k-o');
% hold on 

plot(MER,Cs_secondary_sc,'k-*');
hold on
plot(MER,Cs_secondary_sc_2,'k-v');
hold on
plot(MER, Cs_secondary_sc_3,'k-o'); 
set(gcf,'color','white');
xlabel('MER(dB)')
ylabel('次用户安全容量(bit/s/Hz)')
%legend('location','NorthWest','M=10 N=8 R=8','M=6 N=4 R=4','M=3 N=2 R=2')
legend('location','NorthWest','M=10 N=8 R=8','M=6 N=4 R=4','M=3 N=2 R=2')
